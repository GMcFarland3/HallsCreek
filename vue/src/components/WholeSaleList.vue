<template>
  <div>
    <section class="tree-list">
      <div><h1>Catalog - Whole Sale -</h1></div>
      <div v-for="trees in returnTrees" :key="trees.speciesid" class="tree-card">
        ...
        <div class="tree-info">
          ...
          <div id="subset">
            ...
            <div class="details">Whole Sale Price(s)</div>
          </div>
          <div class="topspacer"></div>
          <div id="subset">
            <div class="details">{{ trees.size1 }}</div>
            <div class="spacer"></div>
            <div class="details">${{ trees.wholesale1 }}</div>
          </div>
          <div class="topspacer"></div>
          <div id="subset">
            <div class="details">{{ trees.size2 }}</div>
            <div class="spacer"></div>
            <div class="details">${{ trees.wholesale2 }}</div>
          </div>
          <div class="topspacer"></div>
          <div id="subset">
            <div class="details">{{ trees.size3 }}</div>
            <div class="spacer"></div>
            <div class="details">${{ trees.wholesale3 }}</div>
          </div>
          <div class="topspacer"></div>
          <div id="subset">
            <div class="details">{{ trees.size4 }}</div>
            <div class="spacer"></div>
            <div class="details">${{ trees.wholesale4 }}</div>
          </div>
          <div class="topspacer"></div>
          <div id="subset">
            <div class="details">{{ trees.size5 }}</div>
            <div class="spacer"></div>
            <div class="details">${{ trees.wholesale5 }}</div>
          </div>
          <div class="topspacer"></div>
          <div id="subset">
            <div class="details">{{ trees.size6 }}</div>
            <div class="spacer"></div>
            <div class="details">${{ trees.wholesale6 }}</div>
          </div>
        </div>
      </div>
    </section>
